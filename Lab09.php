    ...
    <main class="container">
		...
		<ul class="caption-style-2">
		  ...
		  foreach($images as $image){
			  echo '<li><a href="detail.php?id='.$image['id'].'" lass="img-responsive"><img src="images/square/'.$image['path'].'" alt="'.$image['title'].'">';
			  echo '<div class="caption"><div class="blur"></div><div class="caption-text"><h1>'.$image['title'];
			  echo '</h1></div></div></a></li>';
		  }
